...
export const TitleSlide = () => (
  <Slide bgColor="bg-[#0a0a0a]">
    ...
    <div className="relative z-10">
      <img 
        src={`${import.meta.env.BASE_URL}HackTheAI-Logo-v1-Black-bg.png`}
      ...
      <div className="mt-14 flex justify-center items-center gap-12">
        <img src={`${import.meta.env.BASE_URL}SmythOS-for-Dark-BG.png`} alt="SmythOS" className="h-10 opacity-100" />
        <img src={`${import.meta.env.BASE_URL}LOGO-DEPT-OF-Computer-Science-and-Engineering.png`} alt="Dept of CSE" className="h-16 opacity-100" />
        <img src={`${import.meta.env.BASE_URL}LOGO-of-GUCC.png`} alt="GUCC" className="h-16 opacity-100" />
        <img src={`${import.meta.env.BASE_URL}VGS.png`} alt="VGS" className="h-16 opacity-100" />
        <img src={`${import.meta.env.BASE_URL}GUB.png`} alt="Green University" className="h-16 opacity-100" />
      </div>
    </div>
  </Slide>
);
    ...
    <div className="relative z-10">
      ...
      <div className="grid grid-cols-4 gap-8 max-w-7xl mx-auto">
        <div className="bg-white/5 backdrop-blur-sm rounded-lg overflow-hidden border border-white/10">
          <img 
            src={`${import.meta.env.BASE_URL}Workshop-on-Hackathon-101.webp`}
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-lg overflow-hidden border border-white/10">
          <img 
            src={`${import.meta.env.BASE_URL}Training-Session-Day-1.webp`}
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-lg overflow-hidden border border-white/10">
          <img 
            src={`${import.meta.env.BASE_URL}Training-Session-with-GUCC-Day-2.webp`}
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-lg overflow-hidden border border-white/10">
          <img 
            src={`${import.meta.env.BASE_URL}Training-with-SmythOS-day-3.png`}
    ...
    <div className="relative z-10">
      ...
      <div className="grid grid-cols-2 gap-10 max-w-6xl mx-auto">
        <div className="bg-white/5 backdrop-blur-sm p-10 rounded-lg border border-white/10 flex flex-col items-center">
          <img src={`${import.meta.env.BASE_URL}GUB.png`} alt="Green University" className="h-28 mb-5" />
        ...
        <div className="bg-white/5 backdrop-blur-sm p-10 rounded-lg border border-white/10 flex flex-col items-center">
          <img src={`${import.meta.env.BASE_URL}LOGO-of-GUCC.png`} alt="GUCC" className="h-28 mb-5" />
          <h3 className="text-3xl font-bold text-white mb-3">GUCC</h3>
          <p className="text-gray-300 text-center text-xl">ORGANIZER</p>
        </div>
        <div className="bg-white/5 backdrop-blur-sm p-10 rounded-lg border border-white/10 flex flex-col items-center">
          <img src={`${import.meta.env.BASE_URL}LOGO-DEPT-OF-Computer-Science-and-Engineering.png`} alt="CSE Dept" className="h-28 mb-5" />
          <h3 className="text-3xl font-bold text-white mb-3">Dept. of CSE</h3>
          <p className="text-gray-300 text-center text-xl">ORGANIZER</p>
        </div>
        <div className="bg-white/5 backdrop-blur-sm p-10 rounded-lg border border-white/10 flex flex-col items-center">
          <img src={`${import.meta.env.BASE_URL}SmythOS-for-Dark-BG.png`} alt="SmythOS" className="h-20 mb-5" />
      ...
      <div className="grid grid-cols-4 gap-6 max-w-6xl mx-auto">
        {[2, 3, 6, 8, 10, 11, 15, 19].map((num) => (
          <div key={num} className="bg-white/5 backdrop-blur-sm rounded-lg overflow-hidden border border-white/10 hover:scale-105 transition-transform">
            <img 
              src={`${import.meta.env.BASE_URL}${num}.webp`}
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="relative bg-white/5 backdrop-blur-sm rounded-lg overflow-hidden border border-white/10">
            <img 
              src={`${import.meta.env.BASE_URL}${eventMoments[currentImageIndex].file}`}
